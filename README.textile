...
* your commit message must end with "Closes #X." where X is the issue number. for example: <code>Fixes the broken home link. Closes #21.</code>. check out the "Github Issues video":http://github.com/blog/411-github-issue-tracker for more info
