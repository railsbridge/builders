...
* your commit message must end with "Closes #X." where X is the issue number. for example: `Fixes the broken home link. Closes #21.`. check out the "intro video":http://github.com/blog/411-github-issue-tracker" for more info.
